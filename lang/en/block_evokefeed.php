...
$string['portfolio_comment_string'] = 'commented on your post';
$string['portfolio_like_string'] = 'liked your portfolio post';
$string['portfolio_earnedpoints_string'] = 'Earned {$a} points';
$string['portfolio_earnedevocoins_string'] = 'Earned {$a} EVCs';
$string['portfolio_earnedbadge_string'] = 'You earned the {$a} badge';
